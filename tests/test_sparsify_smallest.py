...
class SparsifySmallestTest(unittest.TestCase):
    ...
    def test_no_change_on_network(self):
        ...
        for layer_new, layer_old in zip(self.network.weighted_layers, layers_weights):
    ...
    def test_no_change_on_layers(self):
        ...
        for layer, old_weights in zip(self.network.weighted_layers, layers_weights):
    ...
    def test_zero_for_all_on_network(self):
        ...
        assert_equal(self.get_percentage_of_zeros_in_network(self.network), 100)
    ...
    def test_percentage_of_zeros_on_network(self):
        ...
        for percentage in [10, 30, 50, 60, 90]:
            ...
            assert_true(self.get_percentage_of_zeros_in_network(self.network) == percentage)
    ...
    def test_percentage_of_zeros_on_layers(self):
        ...
        for percentage in [10, 30, 50, 60, 90]:
            ...
            for layer in self.network.weighted_layers:
                assert_true(self.get_percentage_of_zeros_in_layer(layer) == percentage)